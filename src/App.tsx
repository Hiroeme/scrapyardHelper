...
function App() {
  ...
  return (  
    <div className="bg-orange-300 p-8 mt-20 mb-20 mr-auto ml-auto max-w-4xl border-2 rounded-2xl shadow-lg">
      <div className="flex">
        <h1 className="text-3xl font-bold flex-1 p-4">
          GMS Maplestory Scrapyard Helper
        </h1>
          <a href="https://buymeacoffee.com/Hiroeme" className="flex-none flex items-center bg-amber-50 px-4 m-2 border rounded-xl hover:bg-orange-200">
          ...
          <button className="flex-none flex items-center bg-gray-300  px-4 m-2 border rounded-xl hover:bg-gray-500">
